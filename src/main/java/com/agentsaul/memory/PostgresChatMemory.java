...
/**
 * PostgreSQL-backed ChatMemory implementation.
 * Reads the last 20 messages from the messages table for a conversation
 * and writes new messages back via MyBatis MessageMapper.
 */
public class PostgresChatMemory implements ChatMemory {

    private static final Logger log = LoggerFactory.getLogger(PostgresChatMemory.class);
    private static final int WINDOW_SIZE = 20;

    private final Long conversationId;
    private final MessageMapper messageMapper;

    public PostgresChatMemory(Long conversationId, MessageMapper messageMapper) {
    ...
    public void clear(String conversationIdStr) {
        ...
        log.info("PostgresChatMemory: cleared messages for conversationId={}", convId);
    }
